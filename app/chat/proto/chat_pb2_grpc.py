...
class ChatServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.StreamChat = channel.stream_stream(
                '/portfolio_ai.chat.ChatService/StreamChat',
...
def add_ChatServiceServicer_to_server(servicer, server):
    ...
    generic_handler = grpc.method_handlers_generic_handler(
            'portfolio_ai.chat.ChatService', rpc_method_handlers)
    server.add_generic_rpc_handlers((generic_handler,))
    server.add_registered_method_handlers('portfolio_ai.chat.ChatService', rpc_method_handlers)
